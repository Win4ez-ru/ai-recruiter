...
2. Поиск: дедупликация и живой прогресс `HeadHunter 4/7` → `AI-анализ 3/18`.
3. Карточка: score, объяснение, риски, обязательные блокеры и полный режим.
4. Избранное и отменяемое скрытие.
5. Подготовка персонального письма, редактирование и двойное подтверждение.
...
Ожидаемый baseline этой версии: 142 passed, coverage ≥65%, одна Alembic head revision, согласованные зависимости и отсутствие известных уязвимостей.
